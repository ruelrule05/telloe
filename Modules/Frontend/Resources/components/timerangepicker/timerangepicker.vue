<template>
	<div>
		<div class="d-flex align-items-stretch">
			<div class="rounded border w-50 mr-1 flex-grow-1 bg-white">
				<div class="position-relative dropdown d-flex align-items-stretch" ref="start">
					...
					<div class="w-100 position-static">
						<button class="btn btn-white shadow-none border-0 h-100 btn-block" data-toggle="dropdown" data-offset="-50,0" :class="{ 'text-gray': !time_start }" type="button">{{ time_start ? time_start.label : 'Set time' }}</button>
			...
			<div class="rounded border w-50 mr-1 flex-grow-1 bg-white">
				<div class="position-relative dropdown d-flex align-items-stretch" ref="end">
					...
					<div class="w-100 position-static">
						<button class="btn btn-white shadow-none border-0 h-100 btn-block" data-toggle="dropdown" data-display="static" :class="{ 'text-gray': !time_end }" type="button">{{ time_end ? time_end.label : 'Set time' }}</button>
