	...
	<div class="row h-100">
					...
					<div class="d-flex flex-wrap">
						<div class="w-50 p-3" v-for="service in services" :key="service.id">
							<div
								...
								:class="[service == selectedService ? 'active' : 'shadow-sm', { unavailable: !service.is_available }]"
								@click="
		...
		<modal ref="applyBreaktimeToAllModal" :close-button="false">
			<template v-if="selectedService && selectedDay">
				...
				<p class="mt-3">
					This will override the breaktimes of all days for the selected booking type.
					<br />
