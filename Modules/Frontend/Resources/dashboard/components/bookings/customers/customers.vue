	...
	<div class="h-100 p-4" v-if="ready">
		<div class="row h-100">
			<div class="col-md-9">
				...
				<div class="rounded mt-3 overflow-hiddenx">
						...
						<div v-for="customer in user_customers" class="border-top p-3 bg-white rounded shadow-sm mb-3">
							<div class="d-flex align-items-center flex-nowrap">
			                    ...
			                    <div class="flex-grow-1 w-35">
			                    	<div class="badge badge-icon d-inline-flex align-items-center line-hxeight-0" :class="[customer.is_pending ? 'bg-warning-light text-warning' : 'bg-primary-light text-primary']">
			                    ...
			                    <div class="flex-grow-1 w-15 text-right">
			                    	<div class="dropdown">
			                    		<button class="btn btn-white border p-1 line-height-0 badge-pill" data-toggle="dropdown">
											<more-h-icon width="20" height="20"></more-h-icon>
			                    		</button>
										<div class="dropdown-menu dropdown-menu-right">
										    <span class="dropdown-item cursor-pointer" @click="goToConversation(customer)">Manage</span>
			...
			<vue-form-validate @submit="store">
				...
				<div class="form-group">
                    ...
                    <div v-for="service in services" class="d-inline-flex mt-2 border rounded shadow-sm py-2 px-3 mr-2">
                        ...
                        <div class="ml-3">
                            <toggle-switch :value="true" @input="toggleServiceBlacklist($event, service)"></toggle-switch>
                        </div>
                    </div>
				</div>
