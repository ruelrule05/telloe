	...
	<div class="h-100 d-flex flex-column" ref="calendar">
		<div class="border-bottom bg-white p-3 d-flex align-items-center">
			...
			<div class="ml-auto d-flex align-items-center">
				<div class="dropleft d-inline-block mr-2" ref="googleCalendarDropdown">
					<button type="button" class="btn btn-light shadow-none d-inline-flex align-items-center" @click="googleCalendarDropdownToggle" data-toggle="dropdown" data-display="static">
				...
				<div class="dropleft d-inline-block" ref="outlookCalendarDropdown">
					<button type="button" class="btn btn-light shadow-none d-inline-flex align-items-center" @click="outlookCalendarDropdownToggle" data-toggle="dropdown" data-display="static">
