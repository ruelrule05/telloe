<template>
	<div class="overflow-hidden h-100 flex-grow-1 d-flex flex-column" id="subscriptions">
		<div class="d-flex flex-column h-100">
			<div class="border-bottom bg-white p-3 d-flex align-items-center">
				...
				<div class="ml-auto d-flex align-items-center">
					...
					<button :data-intro="$root.intros.subscriptions_index.steps[1]" data-step="2" class="btn btn-light shadow-none d-flex align-items-center" type="button" @click="openInfo = true">
		...
		<modal :close-button="false" ref="createSubscriptionModal" @hidden="resetSubscriptionForm()"></modal>
