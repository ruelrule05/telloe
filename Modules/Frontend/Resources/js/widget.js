    ...
    methods: {
        ...
        submit() {
            if (this.selectedService && this.selectedDate && this.selectedTimeslot) {
                ...
                axios
                    .post(`/@${this.profile.username}/${this.selectedService.id}/book`, data)
                    .then((response) => {
                        this.bookingSuccess = true;
                        this.loginForm.loading = false;
                        this.authForm = false;
        ...
        getTimeslots() {
            if (this.selectedService && this.selectedDate) {
                this.selectedTimeslot = null;
                axios.get(`/@${this.profile.username}/${this.selectedService.id}/timeslots?date=${dayjs(this.selectedDate).format('YYYY-MM-DD')}`).then((response) => {
        ...
        getData() {
            axios.get(`/@${this.profile.username}`).then((response) => {
