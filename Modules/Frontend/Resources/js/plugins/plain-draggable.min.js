	...
	function(t, e, n) {
					...
					[
						...
						},
						{
							...
							value: function(t, e) {
								...
								return v(t, 'mousedown', this.startHandlers[e], { capture: !1, passive: !1 }), v(t, 'touchstart', this.startHandlers[e], { capture: !1, passive: !1 }), v(t, 'dragstart', g, { capture: !1, passive: !1 }), e;
							}
						},
						{
		...
		function _t(t, e) {
			var n = void 0,
				r = void 0;
			return (
				(void 0 === t ? 'undefined' : L(t)) !== (void 0 === e ? 'undefined' : L(e)) ||
				(n = Q(t) ? 'obj' : Array.isArray(t) ? 'array' : '') != (Q(e) ? 'obj' : Array.isArray(e) ? 'array' : '') ||
				('obj' === n
		...
		function Zt(t) {
			...
			return (
				(n[ft] = 'translate(' + (r.left + d.left) + 'px, ' + (r.top + d.top) + 'px)'),
