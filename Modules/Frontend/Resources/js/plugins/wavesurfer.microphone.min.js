			...
			var o = (function() {
				function e(t, r) {
					...
					void 0 === navigator.mediaDevices && (navigator.mediaDevices = {}),
						...
						(this.constraints = this.params.constraints || { video: !1, audio: !0 }),
					...
					n(e, null, [
						{
							key: 'create',
							value: function(t) {
								return { name: 'microphone', deferInit: !(!t || !t.deferInit) && t.deferInit, params: t, instance: e };
							}
						}
					]),
					n(e, [
						...
						},
						{
							...
							value: function() {
								if (((this.active = !1), this.disconnect(), this.stream)) {
									if ((('chrome' === this.browser.browser && this.browser.version >= 45) || ('firefox' === this.browser.browser && this.browser.version >= 44) || 'edge' === this.browser.browser || 'safari' === this.browser.browser) && this.stream.getTracks)
										return void this.stream.getTracks().forEach(function(e) {
											return e.stop();
										});
									this.stream.stop();
								}
