	...
	<div class="row h-100 p-4">
										...
										<div class="py-2">
											<div class="p-2 border shadow-sm rounded">
												<div class="d-flex align-items-center mb-3">
													...
													<toggle-switch @input="update(selectedService)" v-model="selectedService.days[day].isOpen"></toggle-switch>
												</div>
		...
		<modal ref="deleteModal" :close-button="false">
			<template v-if="selectedService">
				...
				<div class="d-flex">
					<button class="btn btn-link text-body" type="button" data-dismiss="modal">Cancel</button>
					<button class="btn btn-danger ml-auto" type="button" @click="destroy(selectedService)">Delete</button>
				</div>
			</template>
		</modal>
	</div>
