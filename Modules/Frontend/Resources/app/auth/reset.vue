	...
	<div class="row h-100 w-100 justify-content-center align-items-center mx-0" v-cloak>
		<div class="col-md-8">
			<div class="text-center" v-if="resetForm.success">
				...
				<button type="button" @click="$root.action = 'login'; resetForm.success = false;" class="btn btn-light btn-block-sm shadow-none d-inline-flex align-items-center"><arrow-left-icon></arrow-left-icon>Log In</button>
			</div>
			...
			<vue-form-validate v-else @submit="reset" class="mt-4">
				...
				<div class="d-flex align-items-center">
					<button type="button" @click="$root.action = 'login'; resetForm.success = false;" class="btn btn-link text-body pl-0 shadow-none d-inline-flex align-items-center"><arrow-left-icon></arrow-left-icon>Log In</button>
