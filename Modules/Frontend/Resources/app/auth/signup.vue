	...
	<div class="row h-100 w-100 justify-content-center align-items-center mx-0" v-cloak>
		<div class="col-md-10">
			<vue-form-validate @submit="signup">
				...
				<div class="small margin-bottom font-weight-light text-muted">By clicking the sign up button, you agree that you've read and accepted Snapturebox's <a href="/terms-of-service" target="_blank" class="underline">Terms of Service</a> and <a href="/privacy-policy" class="underline" target="_blank">Privacy Policy</a>.</div>

				<vue-button type="submit" :loading="loading" button_class="btn btn-primary btn-block btn-lg shadow-none mt-2">Sign Up</vue-button>

				<button type="button" class="btn btn-link btn-sm d-flex align-items-center text-body px-0" @click="$root.action = 'login'"><arrow-left-icon size="1x"></arrow-left-icon> Log In</button>
