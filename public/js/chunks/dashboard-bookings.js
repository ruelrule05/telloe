(self["webpackChunk"] = self["webpackChunk"] || []).push([["dashboard-bookings"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/eslint-loader/dist/cjs.js!./Resources/dashboard/components/bookings/add/add.js?vue&type=script&lang=js&":
/*!***********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/eslint-loader/dist/cjs.js!./Resources/dashboard/components/bookings/add/add.js?vue&type=script&lang=js& ***!
  \***********************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    formatTime: function formatTime(time) {
      ...
      var formatTime = dayjs__WEBPACK_IMPORTED_MODULE_9___default()().hour(parts[0]).minute(parts[1]).format('hh:mmA');
      return formatTime;
    },
    submit: function submit() {
      var _this = this;

      var service = this.assignedService || this.selectedService;

      if (service && this.selectedTimeslots.length > 0) {
        this.$refs['bookingModal'].show().then(function () {
          _this.isBooking = true;
          var data = {
            timeslots: _this.selectedTimeslots
          };
          var target = null;

          if (_this.auth) {
            target = 'auth=true';
          } else if (_this.contactID) {
            target = "contact_id=".concat(_this.contactID);
          }

          if (target) {
            var url = "/@".concat(service.user.username, "/").concat(service.id, "/login_and_book?").concat(target);
            window.axios.post(url, data, {
              toasted: true
            }).then(function (response) {
              _this.bookingSuccess = true;
              _this.authForm = false;
              _this.selectedTimeslots = [];
              _this.bookings = response.data;
            })["catch"](function () {
              setTimeout(function () {
                _this.$refs['bookingModal'].hide().then(function () {
    ...
    daysInMonth: function daysInMonth(timeslot) {
      return [{
        text: "First ".concat(timeslot.date.dayName, " of the month"),
        value: 'first_week'
      }, {
        text: "Second ".concat(timeslot.date.dayName, " of the month"),
        value: 'second_week'
      }, {
        text: "Third ".concat(timeslot.date.dayName, " of the month"),
        value: 'third_week'
      }, {
        text: "Last ".concat(timeslot.date.dayName, " of the month"),
        value: 'last_week'
      }];
    },
    setTimeslotDefaultDay: function setTimeslotDefaultDay(frequency, timeslot) {
      if (frequency == 'week') {
        var dayIndex = this.days.indexOf(timeslot.date.dayName);
        var index = timeslot.days.indexOf(dayIndex);
    ...
    timeslotToggleDay: function timeslotToggleDay(timeslot, dayIndex) {
      var index = timeslot.days.indexOf(dayIndex);
      ...
      if (timeslot.days.length == 0) {
        var _dayIndex = this.days.indexOf(timeslot.date.dayName);

        timeslot.days.push(_dayIndex);
      }
    },
    endTime: function endTime(time) {
      ...
      if (this.selectedService && this.startDate) {
        var startDate = dayjs__WEBPACK_IMPORTED_MODULE_9___default()(dayjs__WEBPACK_IMPORTED_MODULE_9___default()(this.startDate).format('YYYY-MM-DD') + ' ' + time);
        endTime = dayjs__WEBPACK_IMPORTED_MODULE_9___default()(startDate).add(this.selectedService.duration, 'minute').format('hh:mmA');
      }

      return endTime;
    },
    formatDate: function formatDate(date) {
      return dayjs__WEBPACK_IMPORTED_MODULE_9___default()(date).format('MMMM D, YYYY');
    },
    ...
    setSelectedDateAndTimeslot: function setSelectedDateAndTimeslot(date, timeslot) {
      if (timeslot.is_available) {
        ...
        var index = this.selectedTimeslots.findIndex(function (x) {
          return x.date.dayName == date.dayName && x.timeslot.time == timeslot.time;
        });
    ...
    timezoneTime: function timezoneTime(time) {
      var profileTimezone = this.selectedService.user.timezone;
      var timezoneTime;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                if (!_this2.selectedService) {
                  _context.next = 8;
                  break;
                }

                _this2.timeslotsLoading = true;
                _this2.selectedTimeslot = null;
                _context.next = 5;
                return window.axios.get("".concat(window.location.origin, "/ajax/@").concat(_this2.selectedService.user.username, "/").concat(_this2.selectedService.id, "/timeslots?date=").concat(dayjs__WEBPACK_IMPORTED_MODULE_9___default()(_this2.startDate).format('YYYY-MM-DD')), {
                  ajax: false
                });
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/eslint-loader/dist/cjs.js!./Resources/dashboard/components/bookings/bookings.js?vue&type=script&lang=js&":
/*!************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/eslint-loader/dist/cjs.js!./Resources/dashboard/components/bookings/bookings.js?vue&type=script&lang=js& ***!
  \************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _icons_more__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../icons/more */ "./Resources/icons/more.vue");
...
/* harmony import */ var _add_add_vue__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./add/add.vue */ "./Resources/dashboard/components/bookings/add/add.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  components: {
    VCalendar: (v_calendar__WEBPACK_IMPORTED_MODULE_2___default()),
    ...
    MoreIcon: _icons_more__WEBPACK_IMPORTED_MODULE_5__.default,
    ...
    Add: _add_add_vue__WEBPACK_IMPORTED_MODULE_10__.default,
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_12__.mapState)({
    ready: function ready(state) {
      return state.bookings.ready;
    },
    bookings: function bookings(state) {
      return state.bookings.paginated;
    }
  })), {}, {
    formattedHolidays: function formattedHolidays() {
      ...
      if (this.selectedBooking.service) {
        this.selectedBooking.service.holidays.forEach(function (holiday) {
        ...
        this.days.forEach(function (day, index) {
          index++;
          if (!_this.selectedBooking.service.days[day].isOpen) disabledDays.push(index);
        });
    ...
    availableTimeslots: function availableTimeslots() {
      return this.timeslots.filter(function (timeslot) {
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_12__.mapActions)({
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return window.axios.get('/services/contact_services');
    ...
    confirmDeleteBooking: function confirmDeleteBooking(booking) {
      var _this3 = this;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return _this3.deleteBooking(booking);
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _this5.bookingModalLoading = true;
                selectedBooking = JSON.parse(JSON.stringify(selectedBooking));
                selectedBooking.date = dayjs__WEBPACK_IMPORTED_MODULE_1___default()(selectedBooking.date).format('YYYY-MM-DD');
                selectedBooking.start = dayjs__WEBPACK_IMPORTED_MODULE_1___default()(selectedBooking.start).format('HH:mm');
                _context4.next = 6;
                return _this5.updateBooking(selectedBooking)["catch"](function () {});

              case 6:
                updatedBooking = _context4.sent;

                if (updatedBooking) {
                  _this5.$refs['bookingModal'].hide();
                }

                _this5.bookingModalLoading = false;
    ...
    getSelectedBookingNewTimeslots: function getSelectedBookingNewTimeslots(booking, date) {
      var _this6 = this;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _context5.next = 2;
                return window.axios.get("/services/".concat(booking.service.id, "?date=").concat(dayjs__WEBPACK_IMPORTED_MODULE_1___default()(date).format('YYYY-MM-DD'), "&single=1"));

              case 2:
                response = _context5.sent;
                _this6.timeslots = response.data;
    ...
    update: function update(booking) {
      ...
      if (booking) {
        ...
        data.date = dayjs__WEBPACK_IMPORTED_MODULE_1___default()(this.selectedDate).format('YYYY-MM-DD');
        data.start = this.selectedTimeslot.time;
        this.updateBooking(data).then(function () {
          _this7.$refs['editModal'].hide();
        })["catch"](function (e) {
          _this7.error = e.response.data.message;
    ...
    getTimeslots: function getTimeslots() {
      ...
      if (this.selectedBooking && this.selectedDate) {
        ...
        var dateFormat = dayjs__WEBPACK_IMPORTED_MODULE_1___default()(this.selectedDate).format('YYYY-MM-DD');
        window.axios.get("/@".concat(this.selectedBooking.service.user.username, "/").concat(this.selectedBooking.service.id, "/timeslots?date=").concat(dateFormat)).then(function (response) {
          var timeslots = response.data;

          if (_this8.selectedBooking.date == dateFormat) {
            var parts = _this8.selectedBooking.start.split(':');

            var label = dayjs__WEBPACK_IMPORTED_MODULE_1___default()().hour(parts[0]).minute(parts[1]).format('hh:mmA');
            var timeslot = {
              label: label,
          ...
          _this8.$set(_this8.selectedBooking.service, 'timeslots', timeslots);
        });
      }
    },
    formatDate: function formatDate(date) {
    ...
    formatTime: function formatTime(time) {
      var parts = time.split(':');
      var date = dayjs__WEBPACK_IMPORTED_MODULE_1___default()().set('hour', parts[0]).set('minute', parts[1]);
      return date.format('hh:mmA');
    },
    destroy: function destroy(booking) {
      if (booking) {
        this.$refs['deleteModal'].hide();
        window.axios["delete"]("/dashboard/bookings/".concat(booking.id));
        this.$delete(this.bookings, this.bookings.findIndex(function (x) {
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[3]!./Resources/dashboard/components/bookings/add/add.scss?vue&type=style&index=0&id=0d34d294&lang=scss&scoped=true&":
/*!***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[3]!./Resources/dashboard/components/bookings/add/add.scss?vue&type=style&index=0&id=0d34d294&lang=scss&scoped=true& ***!
  \***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, "#add[data-v-0d34d294] {\n  top: 0;\n  left: 0;\n  z-index: 1040;\n  opacity: 1;\n  transition: all 0.1s ease-in-out;\n  background-color: rgba(0, 0, 0, 0.5);\n}\n.user-profile-image[data-v-0d34d294] {\n  height: 40px;\n  width: 40px;\n}\n.user-profile-image span[data-v-0d34d294] {\n  font-size: 16px;\n}\n.timeslot-button[data-v-0d34d294] {\n  -moz-user-select: none;\n  -webkit-user-select: none;\n  -ms-user-select: none;\n      user-select: none;\n}\n.timeslot-button .selected-checkmark[data-v-0d34d294] {\n  right: -2px;\n  top: 50%;\n  transform: translateY(-50%);\n  opacity: 0;\n}\n.timeslot-button.selected[data-v-0d34d294] {\n  background-color: #ffc107 !important;\n}\n.timeslot-button.selected .selected-checkmark[data-v-0d34d294] {\n  opacity: 1;\n}\n.badge-day[data-v-0d34d294] {\n  width: 25px;\n  height: 25px;\n}\n.badge-day span[data-v-0d34d294] {\n  position: absolute;\n  top: 49%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n}\n#bookingModal .disabled[data-v-0d34d294] {\n  opacity: 0 !important;\n  pointer-events: none !important;\n}\n.table-layout-fixed[data-v-0d34d294] {\n  table-layout: fixed !important;\n}\n.hide-tooltip .tooltip[data-v-0d34d294] {\n  display: none !important;\n  opacity: 0 !important;\n  visibility: hidden !important;\n}\n.minh-100[data-v-0d34d294] {\n  min-height: 100%;\n}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[3]!./Resources/dashboard/components/bookings/bookings.scss?vue&type=style&index=0&lang=scss&":
/*!************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[3]!./Resources/dashboard/components/bookings/bookings.scss?vue&type=style&index=0&lang=scss& ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".v-calendar .vc-title {\n  font-family: \"Avenir Next\";\n  font-size: 18px;\n}\n.v-calendar .vc-day-content {\n  line-height: 1;\n}\n.form-body {\n  height: 270px;\n}\n.w-20 {\n  width: 20% !important;\n}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !../../../../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_16_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_16_0_rules_0_use_2_node_modules_sass_loader_dist_cjs_js_clonedRuleSet_16_0_rules_0_use_3_add_scss_vue_type_style_index_0_id_0d34d294_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[2]!../../../../../node_modules/sass-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[3]!./add.scss?vue&type=style&index=0&id=0d34d294&lang=scss&scoped=true& */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[3]!./Resources/dashboard/components/bookings/add/add.scss?vue&type=style&index=0&id=0d34d294&lang=scss&scoped=true&");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_16_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_16_0_rules_0_use_2_node_modules_sass_loader_dist_cjs_js_clonedRuleSet_16_0_rules_0_use_3_add_scss_vue_type_style_index_0_id_0d34d294_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_1__.default, options);
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !../../../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_16_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_16_0_rules_0_use_2_node_modules_sass_loader_dist_cjs_js_clonedRuleSet_16_0_rules_0_use_3_bookings_scss_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[1]!../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[2]!../../../../node_modules/sass-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[3]!./bookings.scss?vue&type=style&index=0&lang=scss& */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[3]!./Resources/dashboard/components/bookings/bookings.scss?vue&type=style&index=0&lang=scss&");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_16_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_16_0_rules_0_use_2_node_modules_sass_loader_dist_cjs_js_clonedRuleSet_16_0_rules_0_use_3_bookings_scss_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_1__.default, options);
...
/***/ "./Resources/dashboard/components/bookings/add/add.vue":
/*!*************************************************************!*\
  !*** ./Resources/dashboard/components/bookings/add/add.vue ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => __WEBPACK_DEFAULT_EXPORT__
/* harmony export */ });
/* harmony import */ var _add_vue_vue_type_template_id_0d34d294_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./add.vue?vue&type=template&id=0d34d294&scoped=true& */ "./Resources/dashboard/components/bookings/add/add.vue?vue&type=template&id=0d34d294&scoped=true&");
/* harmony import */ var _add_js_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./add.js?vue&type=script&lang=js& */ "./Resources/dashboard/components/bookings/add/add.js?vue&type=script&lang=js&");
/* harmony import */ var _add_scss_vue_type_style_index_0_id_0d34d294_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./add.scss?vue&type=style&index=0&id=0d34d294&lang=scss&scoped=true& */ "./Resources/dashboard/components/bookings/add/add.scss?vue&type=style&index=0&id=0d34d294&lang=scss&scoped=true&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! !../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__.default)(
  _add_js_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__.default,
  _add_vue_vue_type_template_id_0d34d294_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render,
  _add_vue_vue_type_template_id_0d34d294_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "0d34d294",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "Resources/dashboard/components/bookings/add/add.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./Resources/dashboard/components/bookings/bookings.vue":
/*!**************************************************************!*\
  !*** ./Resources/dashboard/components/bookings/bookings.vue ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => __WEBPACK_DEFAULT_EXPORT__
/* harmony export */ });
/* harmony import */ var _bookings_vue_vue_type_template_id_c222d2ae___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./bookings.vue?vue&type=template&id=c222d2ae& */ "./Resources/dashboard/components/bookings/bookings.vue?vue&type=template&id=c222d2ae&");
/* harmony import */ var _bookings_js_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./bookings.js?vue&type=script&lang=js& */ "./Resources/dashboard/components/bookings/bookings.js?vue&type=script&lang=js&");
/* harmony import */ var _bookings_scss_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./bookings.scss?vue&type=style&index=0&lang=scss& */ "./Resources/dashboard/components/bookings/bookings.scss?vue&type=style&index=0&lang=scss&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! !../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__.default)(
  ...
  _bookings_vue_vue_type_template_id_c222d2ae___WEBPACK_IMPORTED_MODULE_0__.render,
  _bookings_vue_vue_type_template_id_c222d2ae___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "Resources/dashboard/components/bookings/bookings.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./Resources/dashboard/components/bookings/add/add.js?vue&type=script&lang=js&":
/*!*************************************************************************************!*\
  !*** ./Resources/dashboard/components/bookings/add/add.js?vue&type=script&lang=js& ***!
  \*************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => __WEBPACK_DEFAULT_EXPORT__
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_eslint_loader_dist_cjs_js_add_js_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../../../node_modules/eslint-loader/dist/cjs.js!./add.js?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/eslint-loader/dist/cjs.js!./Resources/dashboard/components/bookings/add/add.js?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_eslint_loader_dist_cjs_js_add_js_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__.default); 

/***/ }),

/***/ "./Resources/dashboard/components/bookings/bookings.js?vue&type=script&lang=js&":
/*!**************************************************************************************!*\
  !*** ./Resources/dashboard/components/bookings/bookings.js?vue&type=script&lang=js& ***!
  \**************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./Resources/dashboard/components/bookings/add/add.scss?vue&type=style&index=0&id=0d34d294&lang=scss&scoped=true&":
/*!************************************************************************************************************************!*\
  !*** ./Resources/dashboard/components/bookings/add/add.scss?vue&type=style&index=0&id=0d34d294&lang=scss&scoped=true& ***!
  \************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_16_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_16_0_rules_0_use_2_node_modules_sass_loader_dist_cjs_js_clonedRuleSet_16_0_rules_0_use_3_add_scss_vue_type_style_index_0_id_0d34d294_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/style-loader/dist/cjs.js!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[2]!../../../../../node_modules/sass-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[3]!./add.scss?vue&type=style&index=0&id=0d34d294&lang=scss&scoped=true& */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[3]!./Resources/dashboard/components/bookings/add/add.scss?vue&type=style&index=0&id=0d34d294&lang=scss&scoped=true&");


/***/ }),

/***/ "./Resources/dashboard/components/bookings/bookings.scss?vue&type=style&index=0&lang=scss&":
/*!*************************************************************************************************!*\
  !*** ./Resources/dashboard/components/bookings/bookings.scss?vue&type=style&index=0&lang=scss& ***!
  \*************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_16_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_16_0_rules_0_use_2_node_modules_sass_loader_dist_cjs_js_clonedRuleSet_16_0_rules_0_use_3_bookings_scss_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/style-loader/dist/cjs.js!../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[1]!../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[2]!../../../../node_modules/sass-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[3]!./bookings.scss?vue&type=style&index=0&lang=scss& */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-16[0].rules[0].use[3]!./Resources/dashboard/components/bookings/bookings.scss?vue&type=style&index=0&lang=scss&");
...
/***/ "./Resources/dashboard/components/bookings/add/add.vue?vue&type=template&id=0d34d294&scoped=true&":
/*!********************************************************************************************************!*\
  !*** ./Resources/dashboard/components/bookings/add/add.vue?vue&type=template&id=0d34d294&scoped=true& ***!
  \********************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_add_vue_vue_type_template_id_0d34d294_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render,
/* harmony export */   "staticRenderFns": () => /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_add_vue_vue_type_template_id_0d34d294_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_add_vue_vue_type_template_id_0d34d294_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./add.vue?vue&type=template&id=0d34d294&scoped=true& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./Resources/dashboard/components/bookings/add/add.vue?vue&type=template&id=0d34d294&scoped=true&");


/***/ }),

/***/ "./Resources/dashboard/components/bookings/bookings.vue?vue&type=template&id=c222d2ae&":
/*!*********************************************************************************************!*\
  !*** ./Resources/dashboard/components/bookings/bookings.vue?vue&type=template&id=c222d2ae& ***!
  \*********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_bookings_vue_vue_type_template_id_c222d2ae___WEBPACK_IMPORTED_MODULE_0__.render,
/* harmony export */   "staticRenderFns": () => /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_bookings_vue_vue_type_template_id_c222d2ae___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_bookings_vue_vue_type_template_id_c222d2ae___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./bookings.vue?vue&type=template&id=c222d2ae& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./Resources/dashboard/components/bookings/bookings.vue?vue&type=template&id=c222d2ae&");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./Resources/dashboard/components/bookings/add/add.vue?vue&type=template&id=0d34d294&scoped=true&":
/*!***********************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./Resources/dashboard/components/bookings/add/add.vue?vue&type=template&id=0d34d294&scoped=true& ***!
  \***********************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  return _c(
    ...
    [
      _c(
        ...
        [
          _c(
            ...
            {
              staticClass:
                "rounded p-4 w-100 minh-100 bg-light position-relative"
            },
            [
              _c(
                "button",
              ...
              !_vm.selectedService
                ? [
                    _c("h2", { staticClass: "font-heading text-center" }, [
                    ...
                    _c("div", { staticClass: "container mt-5" }, [
                      _c(
                        ...
                        _vm._l(_vm.services, function(service) {
                          return _c(
                            "div",
                            { key: service.id, staticClass: "col-md-5" },
                            [
                              _c(
                                "div",
                                {
                                  staticClass:
                                    "card rounded service cursor-pointer mb-3 shadow-sm",
                                  on: {
                                    click: function($event) {
                                ...
                                [
                                  _c("div", { staticClass: "card-body" }, [
                                    _c(
                                      ...
                                      [
                                        _c(
                                          ...
                                          {
                                            staticClass:
                                              "user-profile-image d-inline-block bg-white mb-1",
                                            style: {
                                              "background-image":
                                                "url(" +
                                                service.user.profile_image +
                                                ")"
                                            }
                                          },
                                          [
                                    ...
                                    _c(
                                      "h3",
                                      { staticClass: "font-heading h5 mb-1" },
                                    ...
                                    _c(
                                      ...
                                      {
                                        staticClass:
                                          "d-flex align-items-center mt-4 line-height-1"
                                      },
                                      [
                                        _c(
                                          "div",
                ...
                : _vm.selectedService &&
                  (!_vm.startDate || !_vm.selectedTimeslot)
                ? _c(
                    "div",
                    {
                      key: "service",
                    ...
                    [
                      _c("div", { staticClass: "mb-5 text-left" }, [
                        _c(
                          ...
                          {
                            staticClass:
                              "btn line-height-0 p-0 close float-none mb-3 ml-n1",
                            attrs: { type: "button" },
                            on: {
                              click: function($event) {
                                return _vm.reset()
                        ...
                        [
                            ...
                            [
                              ...
                              _vm.selectedTimeslots.length == 0
                                ? _c(
                                    ...
                                    [_vm._v("Select at least one (1) timeslot")]
                                  )
                                : _vm._e()
                            ]
                          ),
                          ...
                          _c(
                            "div",
                            {
                              directives: [
                                {
                                  ...
                                  value: "Select at least one (1) timeslot",
                                  expression:
                              ...
                              staticClass: "ml-auto",
                              class: {
                                "hide-tooltip": _vm.selectedTimeslots.length > 0
                              }
                            },
                            [
                              _c(
                      ...
                      _c("div", { staticClass: "text-left" }, [
                        _c("div", { staticClass: "pt-3 pb-4 d-flex" }, [
                          _c(
                            "div",
                            {
                              staticClass:
                                                            ...
                                                            "div",
                                                            {
                                                              directives: [
                                                                {
                                                                  ...
                                                                  expression:
                                                                    "timezoneTooltip(selectedService.user.timezone, timeslot)",
                                                                  modifiers: {
                                                                    top: true
                                                                  }
                                                                }
                                                              ...
                                                              class: [
                                                                timeslot.is_available
                                                                  ...
                                                                  : "disabled bg-gray-400 pointer-events-none",
                                                                {
                                                                  selected: _vm.selectedTimeslots.find(
                                                                    function(
                                                                      x
                                                                    ) {
                                                                      return (
                        ...
                        [
                          _c("div", { staticClass: "col-md-5" }, [
                            _c(
                              ...
                              [
                                _c(
                                  "button",
                                  {
                                    staticClass: "btn line-height-0 p-0 close",
                                    attrs: { type: "button" },
                                    on: {
                                      click: function($event) {
                                        _vm.selectedTimeslot = false
                                      }
                                    }
                                  },
                                  [
                                ...
                                _c(
                                  "h4",
                                  { staticClass: "mb-0 font-heading ml-3" },
                                  [_vm._v("Confirm and Book")]
                                )
                              ]
                            ),
                            _vm._v(" "),
                            _c(
                              ...
                              {
                                staticClass:
                                  "bg-white shadow-sm rounded selected-service text-left d-flex"
                              },
                              [
                                _c(
                                  "div",
                                  { staticClass: "p-4 border-right flex-1" },
                                  [
                                    _c(
                                      "h3",
                                      { staticClass: "h3 mb-3 font-heading" },
                                      [_vm._v(_vm._s(_vm.selectedService.name))]
                                    ),
                                    _vm._v(" "),
                                    ...
                                    _c(
                                      ...
                                      [
                                        ...
                                        _vm._v(" "),
                                        _vm._l(_vm.selectedTimeslots, function(
                                          timeslot,
                                          timeslotIndex
                                        ) {
                                          return _c(
                                                  ...
                                                  _c(
                                                    ...
                                                    [
                                                      _c(
                                                        ...
                                                        {
                                                          staticClass:
                                                            "btn btn-sm btn-light p-1 line-height-0 shadow-none",
                                                          attrs: {
                                                            type: "button",
                                                            "data-toggle":
                                                              "dropdown"
                                                                    ...
                                                                    input: function(
                                                                      ...
                                                                      if (
                                                                        ...
                                                                        _vm.$set(
                                                                          ...
                                                                          "frequency",
                                                                          _vm
                                                                            .recurringFrequencies[0]
                                                                            .value
                                                                        )
                                                                        _vm.setTimeslotDefaultDay(
                                                                          "week",
                                                                          timeslot
                                                                        )
                                                                      }
                                                        ...
                                                        _c("vue-select", {
                                                          ...
                                                          on: {
                                                            input: function(
                                                              ...
                                                              return _vm.setTimeslotDefaultDay(
                                                                $event,
                                                                timeslot
                                                              )
                                                            }
                                                            ...
                                                            function(
                                                              ...
                                                              return _c(
                                                                "div",
                                                                {
                                                                  ...
                                                                  key: dayIndex,
                                                                  staticClass:
                                                                    "badge badge-pill badge-day ml-1 cursor-pointer position-relative shadow-sm p-3",
                                                                  class: [
                                                                    timeslot.days.indexOf(
                                                                      dayIndex
                                                                    ) == -1
                                                                      ? "badge-white"
                                                                      : "badge-primary"
                                    ...
                                    _c(
                                      ...
                                      {
                                        staticClass:
                                          "btn btn-primary btn-lg btn-block mt-4",
                                        attrs: { type: "submit" }
                                      },
                                      [_vm._v("Book")]
                                    )
      ...
      _c(
        ...
        {
          ref: "bookingModal",
          attrs: { id: "bookingModal", "close-button": _vm.bookingSuccess },
          on: { hide: _vm.hide }
        },
        [
          _c("div", { staticClass: "text-center position-relative" }, [
            _c(
              "div",
              { class: { disabled: !_vm.bookingSuccess } },
              [
                ...
                _vm._v(" "),
                _c("h6", { staticClass: "h3 font-heading" }, [
                  _vm._v("Booking placed!")
                ]),
                _vm._v(" "),
                _c(
                  "p",
                  { staticClass: "mb-4 h6 font-weight-normal text-muted" },
                  [_vm._v("A booking confirmation has been sent to your email")]
                ),
                _vm._v(" "),
                _vm._l(_vm.bookings, function(booking) {
                  return _c(
                    "div",
                    {
                      key: booking.id,
                      staticClass:
                        "rounded p-3 text-left bg-light d-flex align-items-center mt-3"
                    },
                    [
                      _c("div", [
                        _c("h6", { staticClass: "font-heading mb-1" }, [
                          _vm._v(_vm._s(_vm.formatDate(booking.date)))
                        ]),
                        _vm._v(" "),
                        _c("div", { staticClass: "text-muted" }, [
                          _vm._v(
                            _vm._s(_vm.formatTime(booking.start)) +
                              " - " +
                              _vm._s(_vm.formatTime(booking.end))
                          )
                        ])
                      ]),
                      _vm._v(" "),
                      _c("div", { staticClass: "ml-auto dropdown" }, [
                        _c(
                          "button",
                          {
                            staticClass: "btn btn-white shadow-none",
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./Resources/dashboard/components/bookings/bookings.vue?vue&type=template&id=c222d2ae&":
/*!************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./Resources/dashboard/components/bookings/bookings.vue?vue&type=template&id=c222d2ae& ***!
  \************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function() {
  ...
  return _c(
    ...
    { staticClass: "h-100" },
    [
      _vm.$root.auth.role.role == "customer"
                  ...
                  [
                    _vm.bookings.length == 0
                      ? _c(
                          ...
                          {
                            staticClass:
                              "text-center text-gray position-absolute-center font-weight-lighter"
                          },
                          [
                            _vm._v(
                      ...
                      : _c("div", { staticClass: "d-flex flex-column h-100" }, [
                          _c("div", { staticClass: "d-flex mb-3 px-4 pt-4" }, [
                            _c("h1", { staticClass: "font-heading h3 mb-0" }, [
                              _vm._v("Bookings")
                            ]),
                            _vm._v(" "),
                            _c(
                              ...
                              [
                                _c(
                                  ...
                                  [
                                    _c("plus-icon", {
                                      staticClass: "btn-icon fill-white",
                                      staticStyle: { stroke: "white" }
                                    }),
                                    _vm._v(
                                      "\n\t\t\t\t\t\t\tAdd Booking\n\t\t\t\t\t\t"
                                    )
                          ...
                          _c(
                            "div",
                            {
                              staticClass: "overflow-auto flex-grow-1 px-4 pb-4"
                            },
                            [
                              _c("paginate", {
                              ...
                              _c(
                                ...
                                [
                                  ...
                                  _c(
                                    "tbody",
                                    _vm._l(_vm.bookings.data, function(
                                      booking
                                    ) {
                                      return _c("tr", { key: booking.vue }, [
                                        _c(
                                          "td",
                    ...
                    _c(
                      "modal",
                      {
                        ref: "bookingModal",
                        attrs: {
                          "close-button": (_vm.selectedBooking || {})
                            .isPrevious,
                          scrollable: false
                        }
                      },
                          ...
                          ? _c("div", [
                              ...
                              _c("div", [
                                _c(
                                  ...
                                  {
                                    staticClass:
                                      "d-flex align-items-center text-left mb-3"
                                  },
                                  [
                                    _c(
                                      "div",
                                      {
                                        staticClass:
                                          "font-weight-normal text-secondary w-25"
                                      },
                                      [_vm._v("Service")]
                                    ),
                                    _vm._v(" "),
                                    _c(
                                      "div",
                                      { staticClass: "h6 font-heading mb-0" },
                                      [
                                        _vm._v(
                                          _vm._s(
                                  ...
                                  [
                                    ...
                                    _c(
                                      ...
                                      [
                                        _vm._v(
                                          _vm._s(
                                            _vm.selectedBooking.service.coach
                                              .full_name
                                          )
                                        )
                                      ]
                                ...
                                _c(
                                  ...
                                  [
                                    ...
                                    _vm._v(" "),
                                    _vm.selectedBooking.isPrevious
                                      ? _c(
                                          "div",
                                          {
                                            staticClass: "h6 font-heading mb-0"
                                      ...
                                      : _c("v-date-picker", {
                                          ...
                                          on: {
                                            input: function($event) {
                                              return _vm.getSelectedBookingNewTimeslots(
                                                _vm.selectedBooking,
                                                $event
                                              )
                                            }
                                          ...
                                          model: {
                                            value: _vm.selectedBooking.date,
                                            callback: function($$v) {
                                              _vm.$set(
                                                _vm.selectedBooking,
                                                "date",
                                            ...
                                            expression: "selectedBooking.date"
                                          }
                                        })
                                  ],
                                  1
                                            ...
                                            _c(
                                              ...
                                              [
                                                ...
                                                _c(
                                                  ...
                                                  {
                                                    staticClass:
                                                      "dropdown-menu timeslots-dropdown-menu overflow-y-auto"
                                                  },
                                                  [
                                                    _vm.availableTimeslots
                                                      ...
                                                      ? _c(
                                                          ...
                                                          {
                                                            staticClass:
                                                              "text-center text-gray small px-2 py-1 text-nowrap"
                                                          },
                                                          [
                                                            _vm._v(
                                  ...
                                  [
                                    ...
                                    _c(
                                      ...
                                      [
                                        _vm._v(
                                          _vm._s(
                                            _vm.selectedBooking.service.duration
                                          ) + " minutes"
                                        )
                                      ]
                                    )
                                ...
                                _vm._v(" "),
                                _vm.selectedBooking.booking_note.note
                                  ? _c(
                                      "div",
                                      {
                                        staticClass:
                                          "d-flex align-items-center text-left mt-3"
                                      },
                                      [
                                        _c(
                                          "div",
                                          {
                                            staticClass:
                                              "font-weight-normal text-secondary w-25 mb-2"
                                          },
                                          [_vm._v("Notes")]
                                        ),
                                        _vm._v(" "),
                                        _c(
                                          "p",
                                          { staticClass: "mb-0 flex-1" },
                                          [
                                            _vm._v(
                                              _vm._s(
                                                _vm.selectedBooking.booking_note
                                                  .note
                                              )
                                            )
                                          ]
                                ...
                                !_vm.selectedBooking.isPrevious
                                  ? _c("div", { staticClass: "text-left" }, [
                                      Object.keys(_vm.selectedBooking.zoom_link)
                                        .length > 0
                                      ...
                                      _c(
                                        "vue-button",
                                        {
                                          attrs: {
                                            type: "button",
                                            button_class:
                                              "btn btn-primary shadow-sm border",
                                            loading: _vm.bookingModalLoading
                                          },
                                          nativeOn: {
                                            click: function($event) {
                                              return _vm.updateSelectedBooking(
                                                _vm.selectedBooking
                                              )
                                            }
                                          }
      ...
      _c("add", {
        ref: "add",
        attrs: { services: _vm.services, auth: true },
        on: {
          hide: function($event) {
...
var staticRenderFns = [
  function() {
    ...
    return _c("thead", [
      _c("tr", [
        _c("th", { staticClass: "border-0" }, [_vm._v("Service")]),
        _vm._v(" "),
        _c("th", { staticClass: "border-0" }, [_vm._v("Date")]),
        _vm._v(" "),
        _c("th", { staticClass: "border-0" }, [_vm._v("Start")]),
        _vm._v(" "),
        _c("th", { staticClass: "border-0" }, [_vm._v("End")]),
        _vm._v(" "),
