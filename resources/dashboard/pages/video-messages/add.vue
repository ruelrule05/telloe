								...
								<div class="flex items-center mt-2">
									<div class="flex-grow">
										<div class="flex items-center rounded-full bg-gray-200 p-1" style="border-radius: 20px">
											<div class="py-1 px-2 message-input h-auto overflow-auto flex-grow focus:outline-none" @keypress="messageInput" contenteditable data-placeholder="Write a message.." spellcheck="false" ref="messageInput">{{ videoMessageData.retainMessage }}</div>
