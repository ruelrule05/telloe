  ...
  <div class="business-hours-day">
    <div v-for="({ open, close, id, isOpen }, index) in hours" :key="id">
      <div class="flex-table" role="rowgroup">
        <div class="d-flex align-items-center mb-2 bhours-heading">
        ...
        <div class="d-flex text-nowrap align-items-center justify-content-xaround">
          <div class="flex-row hours open flex-grow-1" role="cell" v-visible="isOpenToday">
            <BusinessHoursSelect
              v-if="type === 'select'"
              :name="name"
          ...
          <div class="flex-row dash text-center" role="cell" v-visible="isOpenToday">-</div>
          <div class="flex-row hours flex-grow-1" role="cell" v-visible="isOpenToday">
            <BusinessHoursSelect
              v-if="type === 'select'"
              :name="name"
          ...
          <div class="actions text-right">
            ...
            <button
              type="button"
              class="btn btn-sm btn-primary badge-pill p-1 line-height-1"
              v-if="showAddButton(index)"
              @click="addRow()"
            >
             <plus-icon height="15" width="15" fill="white"></plus-icon></button>
            </div>
          </div>
        </div>
      </div>
