<template>
    <svg version="1" xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" enable-background="new 0 0 48 48">
        <path fill="#CFD8DC" d="M5,38V14h38v24c0,2.2-1.8,4-4,4H9C6.8,42,5,40.2,5,38z" />
        <path fill="#5D21D2" d="M43,10v6H5v-6c0-2.2,1.8-4,4-4h30C41.2,6,43,7.8,43,10z" />
        <g fill="#B71C1C">
        ...
        <rect x="29" y="29" fill="#5D21D2" width="6" height="6" />
    </svg>
</template>
