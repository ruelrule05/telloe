...
<html lang="en">
	...
	<body class="overflow-hidden w-screen h-screen">
		<div id="app" class="flex overflow-hidden" v-cloak v-if="auth">
			...
			<div v-else class="absolute-center w-full px-10">
				<div class="bg-secondary rounded-xl p-4">This app is not optimized for mobile. Please access your dashboard using desktop.</div>
			</div>
		</div>
