...
@section('title', ucwords("Privacy Policy"))

@section('content')
	<div class="container py-5">
		<div class="row justify-content-center">
			<div class="col-md-10">
				<h1 class="font-heading mb-5">Privacy Policy</h1>

				<h3 class="h5">Collection of information</h3>
				<p class="mb-4">
				...
				<h3 class="h5">Access to and correction of information</h3>
				<p class="mb-4">
