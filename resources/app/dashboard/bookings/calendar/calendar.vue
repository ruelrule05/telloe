					...
					<div v-if="selectedDateBookings.length > 0">
						<div v-for="booking in selectedDateBookings" class="py-2 border-bottom booking">
							<div class="d-flex align-items-center">
								...
								<div class="ml-auto">
									<router-link :to="`/dashboard/messages?user_id=${booking.user_id}&tab=bookings`" class="btn btn-sm btn-link p-0 text-body opacity-0">Manage</router-link>
								</div>
							</div>
						</div>
					</div>
