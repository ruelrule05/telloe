						...
						<tr v-for="booking in bookings">
							...
							<td class="align-middle" style="width:50px">
								<div class="d-flex align-items-center justify-content-end">
									<button class="btn btn-link btn-sm text-body px-0 py-0" @click="edit(booking)"><strong>Edit</strong></button>
									<button class="btn btn-link btn-sm text-danger px-0 py-0 ml-3" @click="selectedBooking = booking; $refs['deleteModal'].show();"><strong>Delete</strong></button>
								</div>
							</td>
						</tr>
					</tbody>
			...
			<template v-if="selectedBooking">
				...
				<vue-form-validate @submit="update(selectedBooking)">
					...
					<div class="d-flex mt-3">
						<button v-if="step > 1" type="button" class="btn btn-link text-body" @click="step--">Previous</button>
