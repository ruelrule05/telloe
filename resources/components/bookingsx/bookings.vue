			...
			<div class="mt-2">
		        <div v-for="booking in bookings" class="py-2 booking border-bottom">
		        	...
		        	<div class="booking-edit bg-white rounded p-2 shadow-sm" :class="{'d-block': selectedBooking && selectedBooking.id == booking.id}">
						...
						<div class="d-flex mt-2">
							<button type="button" class="btn btn-sm btn-link text-body" @click="selectedBooking = null">Cancel</button>
		        	...
		        	<div v-if="!selectedBooking || selectedBooking.id != booking.id" class="d-flex align-items-center">
			            ...
			            <div class="ml-auto opacity-0">
			                ...
			                <button type="button" class="ml-1 btn btn-sm btn-link p-0 text-danger" @click="destroy(booking)"><u>Delete</u></button>
			            </div>
		            </div>
		        </div>
	        </div>
