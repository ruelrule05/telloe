...
(function(global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? (module.exports = factory()) : typeof define === 'function' && define.amd ? define(factory) : (global.VueCreditCardValidation = factory());
})(this, function() {
	'use strict';
	...
	var validation = {
		...
		cardType: function(num) {
			...
			return (
				cardFormatUtils.__guard__(cardFormatUtils.cardFromNumber(num), function(x) {
					return x.type;
				}) || null
			);
		},
	...
	var cardFormatUtils = {
		...
		hasTextSelected: function(target) {
			...
			if (
				cardFormatUtils.__guard__(typeof document !== 'undefined' && document !== null ? document.selection : undefined, function(x) {
